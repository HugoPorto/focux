    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('icmscompra') ?></th>
                <th scope="col"><?= $this->Paginator->sort('icmsvenda') ?></th>
                <th scope="col"><?= $this->Paginator->sort('aliquota_interestadual') ?></th>
                <th scope="col"><?= $this->Paginator->sort('aliquota_fcp') ?></th>
