...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Tablesmyprecious'), ['action' => 'edit', $tablesmyprecious->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Tablesmyprecious'), ['action' => 'delete', $tablesmyprecious->id], ['confirm' => __('Are you sure you want to delete # {0}?', $tablesmyprecious->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Tablesmyprecious'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Tablesmyprecious'), ['action' => 'add']) ?> </li>
    </ul>
</nav>
<div class="tablesmyprecious view large-9 medium-8 columns content">
