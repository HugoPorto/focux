...
<div class="row">
    ...
    <div class=col-md-4 style="overflow: auto; height: 570px;">
        ...
        <?php foreach ($videosAdonis as $vadonis): ?>                         
            <div class="col-md-12" style="margin-top: 5px; padding: 0px">  
                <?php if($role == 'admin' || $role == 'root'):?>
                    <div class="col-md-12" style="padding: 0px 0px 10px 0px">
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $vadonis->id], ['class' => 'btn btn-danger']) ?>                
                        <?php if($role == 'root'):?>                    
                            <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $vadonis->id], ['confirm' => __('Are you sure you want to delete # {0}?', $vadonis->id), 'class' => 'btn btn-danger']) ?>
                        <?php endif;?>
                    </div>
                <?php endif;?>
                <div class="box-body" style="padding:0px">                
                <div class="col-md-12" style="padding: 0px; border-top: 10px solid #DD4B39; border-bottom: 10px solid #DD4B39">
                        <?php
                            echo $this->Html->link(
                                $this->Html->image($vadonis->photo, ['class' => 'img-responsive']),
                                ['action' => 'view', $vadonis->id],
                                ['escape' => false]
                            );
                        ?>                    
                    </div>                        
                ...
                <div class="box-header" style="margin-top: 0px; padding:0px">
                    <p style="font-size: 12px" class="box-title"><b><?= h($vadonis->title); ?></b></p>
                    <?php if($vadonis->link_share):?>
                        <p style="margin-bottom: 0px">
                            <a href="<?= $vadonis->link_share;?>" target="_blank"><?= $vadonis->description;?></a>
                        </p>
                    <?php endif;?>
                    <span class="label label-danger"><?= h($vadonis->created) ?></span>
                    <br>
                    <br>
                </div>
            </div>                   
        ...
        <?php if($role == 'common'):?>
            ...
            var ad_idzone = "3770417",
            ad_width = "250",
            ad_height = "250"
        </script>
        <script type="application/javascript" src="https://a.exdynsrv.com/ads.js"></script>
        <noscript>
            <iframe src="https://syndication.exdynsrv.com/ads-iframe-display.php?idzone=3770417&output=noscript&type=250x250" width="250" height="250" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe>
        </noscript>
        <?php endif;?>
...
<div class="row">
    <div class="col-md-12">
    <script type="application/javascript">
    var ad_idzone = "3770161",
    ad_width = "900",
    ad_height = "250"
</script>
<script type="application/javascript" src="https://a.exdynsrv.com/ads.js"></script>
<noscript>
    <iframe src="https://syndication.exdynsrv.com/ads-iframe-display.php?idzone=3770161&output=noscript&type=900x250" width="900" height="250" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe>
</noscript>
    </div>
</div>
