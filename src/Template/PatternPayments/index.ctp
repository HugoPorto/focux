 ...
 * @var \App\Model\Entity\PatternPayment[]|\Cake\Collection\CollectionInterface $patternPayments
 */
?>
...
<div class="patternPayments index large-9 medium-8 columns content">
    <h3><?= __('Pattern Payments') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('ownersid') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $patternPayment->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $patternPayment->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $patternPayment->id], ['confirm' => __('Are you sure you want to delete # {0}?', $patternPayment->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
