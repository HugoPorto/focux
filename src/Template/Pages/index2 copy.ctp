...
<body class="homepage">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="/viewx/about">Sobre Nós</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <section id="feature">
        <div class="container">
            <div class="center wow fadeInDown">
                ...
                <p class="lead"> Veja abaixo algumas de<br> nossas principais características</p>
            </div>
            <div class="row">
                <div class="features">
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h2>Compromisso</h2>
                            <h3>Comprimisso com o a sua satisfação</h3>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h3>Solicitude na resolução de suas necessidades</h3>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h3>Processos simples para uma entrega mas ágil</h3>
                        </div>
                    </div>
                    <!-- <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
    ...
    <section id="services" class="service-item">
        <div class="container">
            <div class="center wow fadeInDown">
                <h2>Serviços</h2>
                <p class="lead">Veja abaixo <br> alguns de nossos serviços</p>
            </div>
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="media services-wrap wow fadeInDown">
                        ...
                        <div class="media-body">
                            <h3 class="media-heading">Comunicação Visual</h3>
                            <p>Produção e montagem de fachadas para empresas de pequeno médio e grande porte
                                como lojas, supermercados, clínicas, 
                            consultórios e etc...</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4">
                    <div class="media services-wrap wow fadeInDown">
                        ...
                        <div class="media-body">
                            <h3 class="media-heading">Gráfica</h3>
                            <p> Adesivos para carros, envelopagem promocional de vans, ônibus, 
                                carros, ambulâncias e muito mais, venha conferir nossos ótimos preços e condições...</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4">
                    <div class="media services-wrap wow fadeInDown">
                        ...
                        <div class="media-body">
                            ...
                            <p>Desenvolvimento de aplicativos móveis, sites, 
                                e sistemas desktop, bem como a integração desses sistemas.</p>
                        </div>
                    </div>
                </div>
                <!-- <div class="col-sm-6 col-md-4">
        ...
        <div class="container">
            <div class="row">
                ...
                <!-- <div class="col-sm-6 wow fadeInDown">
                    <div class="accordion">
                        <h2>Por que gostamos de quem não gosta da gente?</h2>
