 ...
 * @var \App\Model\Entity\Solicitation[]|\Cake\Collection\CollectionInterface $solicitations
 */
?>
...
<div class="solicitations index large-9 medium-8 columns content">
    <h3><?= __('Solicitations') ?></h3>
